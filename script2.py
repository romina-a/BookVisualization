...
book_name = extract_book_name_from_adr(book_address)
...
t = time.time()
G = create_character_MultiGraph(book_address)
...
GraphProssesing.topk_pagerank_history(G, num_of_snapshots=30, k=10)
